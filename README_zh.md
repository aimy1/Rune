<img width="2397" height="1432" alt="屏幕截图_20260709_103741" src="https://github.com/user-attachments/assets/847569e2-c69f-4dd3-8025-f341f285a1eb" />
<div align="center">
 ...
 **🌐 语言 / Language**
 ...
 | 📁 | **响应式文件管理器** — Dolphin 灵感的双栏文件浏览器，支持自适应列、剪切暗色淡化、以及全套文件管理功能 |
 ...
 | 键位 | 功能 |
 | :--- | :--- |
 | `Tab` / `Shift-Tab` | 在各个面板之间循环切换焦点 |
 | `←` / `→` | 在左侧收藏夹（侧边栏）与右侧文件列表之间切换焦点 |
 | `Backspace` | 返回上一级目录（退出的子目录会在返回时自动高亮定位） |
 | `Alt-c` / `Alt-x` | 复制 / 剪切当前选中的文件（被剪切的文件会被自动变暗淡化） |
 | `Alt-v` | 粘贴剪贴板中的文件（命名冲突时自动重命名并添加数值后缀） |
 | `Alt-d` / `Delete` | 删除选中的文件或文件夹 |
 | `Alt-r` | 将选中的文件/文件夹重命名为当前搜索框中的文本 |
 | `Alt-n` / `Alt-f` | 以当前搜索框中的文本新建文件夹 / 文件 |
 | `F4` / `Alt-t` | 在当前目录下启动用户默认 Shell 终端 |
 | `Alt-o` | 在系统的图形化文件管理器（如 Dolphin、Nautilus）中打开当前目录 |
